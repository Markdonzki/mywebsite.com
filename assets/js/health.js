$(document).ready(function(){
    ...
    function health(){
        healthProduct.forEach(health => {
            $('.p-container').append(`
            <a href="${health.link}">
                <div class="product">
                    <div class="p-pic">
                        <img src="${health.img}" alt="">
                    </div>
                    <div class="p-disc">
                        <p>${health.product_name}</p>
                        <p class="price">${health.price}</p>
                        <p class="seller"><i class="fa fa-bars"></i> ${health.category}</p>
                        <p class="date"><i class="fa fa-calendar"></i> ${health.date}</p>
                        <p><i class="fa fa-map-marker"></i> ${health.location}</p>
                    </div>
                </div>
            </a>
            `)
    ...
    $('.total').append(`Health Category: ${healthProduct.length}`);
